package com.miguelsantos.cameraxcodelab
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Set up listener for take photo button
        main_camera_btn.setOnClickListener { takePhoto() }
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            val preview = Preview.Builder()
                .build()
                .also { it.setSurfaceProvider(main_viewFinder.surfaceProvider) }
            ...
            try {
                ...
                cameraProvider.bindToLifecycle(
                    this, cameraSelector, preview, imgCapture, imageAnalyzer
                )
            } catch (e: Exception) {
                e.printStackTrace()
            }
